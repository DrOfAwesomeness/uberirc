...
describe "IrcMessageParser", ->
  describe "#parseIrcMessage", ->
    ...
    it "should properly parse message origins", ->
      ...
      servermessage.origin.type.should.equal IrcMessageParser.messageOriginTypes.SERVER
      servermessage.origin.server.should.equal "server.foonet.net"
      usermessage.origin.type.should.equal IrcMessageParser.messageOriginTypes.USER
    ...
    it "should properly parse chat messages sent to channels", ->
      ...
      channelmessage.origin.type.should.equal IrcMessageParser.messageOriginTypes.USER
